...
Your workflow **must** interact with the following:
...
1. **Daily Standup Automation**  
   ...
   - Steps: Fetch last 24h messages from Slack → Summarize with AI Agent→ Post summary to a channel → Store in Sheets for history  
